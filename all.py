        ...
        for link in links:
            ...
            if linked_page:
                ...
                if linked_page_content:
                    ...
                    # save link text to a text file -  not sure anymore if needed
                    link_text_file = os.path.join(folder_name, f"{sanitized_link_text}_link.txt")
                    with open(link_text_file, 'w', encoding='utf-8') as file:
